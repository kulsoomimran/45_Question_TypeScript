...
let guestList: string[] = ["Farah", "Saad", "Laiba", "Dua"];
...
while (guestList.length > 2) {
  ...
  console.log(
    `Sorry ${excludedGuest}, Due to little space, I can't invite you for dinner.`
  );
}
console.log("\n\t'SHRINKED GUEST LIST'\n");
for (let l = 0; l < guestList.length; l++) {
  console.log(
    `Dear ${guestList[l]}, You're still invited for a dinner at my home.`
  );
}
guestList.pop();
guestList.pop();
